        ...
        for tag in tags:
            ...
            #["PPO", "PPO_EASY_OBS"]
                   ...
                   # if color in locals():
                    ...
                    #                   zorder=1)
                    #
                    # plt.gca().axhline(-11.029478458049892, linestyle='dotted', color="magenta", linewidth=.5,
                    #                   zorder=1)
                    ...
                    # #minor_ticks = [0, -1000, -2000, -6000]
                    # minor_ticks = [0, -1000, -2000]
                    # #plt.gca().set_yticks(minor_ticks, minor=False)
                    # plt.gca().set_yticks([-500,-1500], minor=True)
                    # plt.gca().set_xticks([0, 200, 400, 600, 800], minor=False)
                    #minor_ticks = [100, 300, 500, 700]
                    #plt.gca().set_xticks(minor_ticks, minor=True)
                    # plt.gca().axhline(0, linestyle='dotted', color="black", linewidth=.75, zorder=1)
                    # plt.gca().axhline(-1500, linestyle='dotted', color=(169 / 255, 169 / 255, 169 / 255), linewidth=.5,
                    #                   zorder=1)
                    # plt.gca().axhline(-500, linestyle='dotted', color=(169 / 255, 169 / 255, 169 / 255), linewidth=.5,
                    #                   zorder=1)
...
if __name__ == '__main__':
    ...
    #print(reward_at(theta=4* pi, thdot=0))
    #print(reward_at(theta=6* pi, thdot=0))

    # gain_matrix = None
    # Gain matrix for current configuration
    #from thesis.matlab.ma
